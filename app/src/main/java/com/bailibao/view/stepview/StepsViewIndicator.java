package com.bailibao.view.stepview;
...
public class StepsViewIndicator extends View {
    ...
    private void init() {
        ...
        mCircleRadius = 0.3f * mThumbRadius;
...
////            canvas.drawBitmap(mUnSelectBitmap,mThumbContainerXPosition.get(i),0,paint);
//        }
        ...
        for (int i = 0; i < mThumbContainerXPosition.size() - 1; i++) {
            ...
            canvas.drawLine(pos + mCircleRadius,mCenterY,pos2-mCircleRadius,mCenterY,paint);
        }
        ...
        selectedPaint.setStyle(Paint.Style.FILL);
        selectedPaint.setColor(getResources().getColor(R.color.register_line_color));
        for (int i = 0; i < mThumbContainerXPosition.size(); i++) {
