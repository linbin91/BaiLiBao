...
public class DashedLine extends View{
    ...
    public DashedLine(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        this. paint.setStrokeWidth(ScreenUtil. dip2px(getContext(), 2.0F));
        float[] arrayOfFloat = new float[4];
        arrayOfFloat[0] = ScreenUtil. dip2px(getContext(), 3.0F);
        arrayOfFloat[1] = ScreenUtil. dip2px(getContext(), 3.0F);
        arrayOfFloat[2] = ScreenUtil. dip2px(getContext(), 3.0F);
        arrayOfFloat[3] = ScreenUtil. dip2px(getContext(), 3.0F);
        this. pe = new DashPathEffect(arrayOfFloat, ScreenUtil.dip2px(getContext(), 1.0F));
    }
